...
prog.command('dev')
    ...
    .action((opts) => index$1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        watcher.on('ready', (event) => index$1.__awaiter(void 0, void 0, void 0, function* () {
            if (first) {
...
prog.command('build [dest]')
    ...
    .action((dest = '__sapper__/build', opts) => index$1.__awaiter(void 0, void 0, void 0, function* () {
...
prog.command('export [dest]')
    ...
    .action((dest = '__sapper__/export', opts) => index$1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        if (opts.build) {
            console.log(`> Building...`);
        ...
        const { default: pb } = yield Promise.resolve().then(function () { return require('./index2.js'); }).then(function (n) { return n.index; });
        yield _export({
            cwd: opts.cwd,
            static: opts.static,
            ...
            onfile: event => {
                const size_color = event.size > 150000 ? index$1.$.bold().red : event.size > 50000 ? index$1.$.bold().yellow : index$1.$.bold().gray;
                const size_label = size_color(index$1.left_pad(pb(event.size), 10));
        ...
        console.error(index$1.$.bold().red(`> ${err.message}`));
        process.exit(1);
    }
}));
