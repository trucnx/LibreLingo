        ...
        return index.__awaiter(this, void 0, void 0, function* () {
                ...
                handle_result: (result) => {
                    deferred.promise.then(() => {
                        ...
                        if (this.proc) {
                            ...
                            this.proc.kill();
                            this.proc.on('exit', () => index.__awaiter(this, void 0, void 0, function* () {
                                start_server();
                                yield restart();
            ...
            this.watch(compilers.client, {
                ...
                handle_result: (result) => {
                    ...
                    if (this.bundler === 'rollup') {
                        copy_runtime.inject_resources(path.join(this.dirs.dest, 'build.json'), path.join(this.dirs.dest, 'client'));
                    }
